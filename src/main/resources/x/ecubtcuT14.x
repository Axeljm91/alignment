...
program RPC_PROGRAM {
    version RPC_VERSION {
        ...
        beamLineTurnOnBeamLineModularDevices_out BEAMLINETURNONBEAMLINEMODULARDEVICES(void) = 76;
        beamLineTurnOffBeamLineModularDevices_out BEAMLINETURNOFFBEAMLINEMODULARDEVICES(void) = 77;
