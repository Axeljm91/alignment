...
program RPC_PROGRAM {
    version RPC_VERSION {
        ...
        degraderGoSpecialBlock_out DEGRADERGOSPECIALBLOCK(degraderGoSpecialBlock_in) = 41;
        degraderGoOnePlus_out DEGRADERGOONEPLUS(void) = 42;
        degraderGoOneMinus_out DEGRADERGOONEMINUS(void) = 43;
        degraderCheckSpecialBlock_out DEGRADERCHECKSPECIALBLOCK(degraderCheckSpecialBlock_in) = 44;
        degraderGoEnergy_out DEGRADERGOENERGY(degraderGoEnergy_in) = 45;
        degraderCheckEnergy_out DEGRADERCHECKENERGY(degraderCheckEnergy_in) = 46;
        degarderStop_out DEGARDERSTOP(void) = 47;
        ...
        motorisedSlitsHome_out MOTORISEDSLITSHOME(motorisedSlitsHome_in) = 56;
        motorisedSlitsGoHome_out MOTORISEDSLITSGOHOME(motorisedSlitsGoHome_in) = 57;
        motorisedSlitsGoToPosition_out MOTORISEDSLITSGOTOPOSITION(motorisedSlitsGoToPosition_in) = 58;
        motorisedSlitsGoToOpening_out MOTORISEDSLITSGOTOOPENING(motorisedSlitsGoToOpening_in) = 59;
        motorisedSlitsStop_out MOTORISEDSLITSSTOP(motorisedSlitsStop_in) = 60;
        beamLineSelectBeamLine_out BEAMLINESELECTBEAMLINE(beamLineSelectBeamLine_in) = 61;
        beamLineUnselectBeamLine_out BEAMLINEUNSELECTBEAMLINE(void) = 62;
        beamLineSetRange_out BEAMLINESETRANGE(beamLineSetRange_in) = 63;
        beamLineSetDegraderToRange_out BEAMLINESETDEGRADERTORANGE(void) = 64;
        beamLineSetLineToRange_out BEAMLINESETLINETORANGE(beamLineSetLineToRange_in) = 65;
        beamLineSelectAndSetToRange_out BEAMLINESELECTANDSETTORANGE(beamLineSelectAndSetToRange_in) = 66;
        beamLineSetDegraderToBeamStop_out BEAMLINESETDEGRADERTOBEAMSTOP(void) = 67;
        beamLineStartTuning_out BEAMLINESTARTTUNING(beamLineStartTuning_in) = 68;
        beamLineStopTuning_out BEAMLINESTOPTUNING(void) = 69;
        beamLineResetTuning_out BEAMLINERESETTUNING(void) = 70;
        beamLineTuneNextBlock_out BEAMLINETUNENEXTBLOCK(void) = 71;
        beamLineRedoTuningBlock_out BEAMLINEREDOTUNINGBLOCK(void) = 72;
        beamLineByPassTuningBlock_out BEAMLINEBYPASSTUNINGBLOCK(void) = 73;
        beamLineManualAcquire_out BEAMLINEMANUALACQUIRE(void) = 74;
        beamLineStopManualAcquire_out BEAMLINESTOPMANUALACQUIRE(void) = 75;
        beamLineSaveReferenceSetPoint_out BEAMLINESAVEREFERENCESETPOINT(beamLineSaveReferenceSetPoint_in) = 76;
        beamLineStartPhaseSpace_out BEAMLINESTARTPHASESPACE(beamLineStartPhaseSpace_in) = 77;
        ecuTcuBeamTuningNotStarted_out ECUTCUBEAMTUNINGNOTSTARTED(void) = 78;
        ecuTcuBeamTuningStarted_out ECUTCUBEAMTUNINGSTARTED(void) = 79;
        ecuTcuCountingNotStarted_out ECUTCUCOUNTINGNOTSTARTED(void) = 80;
        ecuTcuCountingStarted_out ECUTCUCOUNTINGSTARTED(void) = 81;
        ecuTcuOnRequestAcquisition_out ECUTCUONREQUESTACQUISITION(ecuTcuOnRequestAcquisition_in) = 82;
    } = 1;
} = 55555129;
