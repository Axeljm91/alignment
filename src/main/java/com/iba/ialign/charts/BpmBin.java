...
/**
 * A bin for the {@link BpmDataset}.
 */
public class BpmBin implements Comparable,
     ...
     */
    public BpmBin(double lowerBound, double upperBound) {
     ...
     * @return A boolean.
     */
    public boolean overlapsWith(BpmBin bin) {
    ...
    public int compareTo(Object obj) {
        if (!(obj instanceof BpmBin)) {
            return 0;
        }
        BpmBin bin = (BpmBin) obj;
