package com.iba.ialign.borders;
...
public class TitledBorderNoEdge extends AbstractBorder{
     ...
     */
    public TitledBorderNoEdge(String title) {
     ...
     */
    public TitledBorderNoEdge(Border border) {
     ...
     * @param title  the title the border should display
     */
    public TitledBorderNoEdge(Border border, String title) {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if ((title != null) && !title.isEmpty()) {
            int edge = (border instanceof javax.swing.border.TitledBorder) ? 0 : EDGE_SPACING;
    ...
    public Component.BaselineResizeBehavior getBaselineResizeBehavior(
        ...
        switch (getPosition()) {
            case javax.swing.border.TitledBorder.ABOVE_TOP:
            case javax.swing.border.TitledBorder.TOP:
            case javax.swing.border.TitledBorder.BELOW_TOP:
                return Component.BaselineResizeBehavior.CONSTANT_ASCENT;
            case javax.swing.border.TitledBorder.ABOVE_BOTTOM:
            case javax.swing.border.TitledBorder.BOTTOM:
            case javax.swing.border.TitledBorder.BELOW_BOTTOM:
